...
votes_in_lobby = {}
# name_lobby: {name_member: role, ...}
roles_in_lobby = {}
# name_lobby: police_member
police_in_lobby = {}
# name_lobby: {name_member: used(True, False), ...}
used_mafia_in_lobby = {}
# name_lobby: {name_member: used(True, False), ...}
used_votes_in_lobby = {}
# name_lobby: {name_member: used(True, False), ...}
used_votes_kill_in_lobby = {}
# name_lobby: [channel_1, channel_2, ...]
channel_for_lobby = {}
# [name_lobby, ...]
prepared_lobby = []
# name_lobby: time
        ...
        if ctx.author == leader_lobby[name_lobby]:
            try:
                ...
                if len(data_lobby[name_lobby]) >= 5:
                    ...
                    channel_for_lobby[name_lobby] = [channel_text_all, channel_voice_all, channel_mafia, channel_police]
                            ...
                            if status_lobby[game]:
                                ...
                                for game_id in candidate_to_kill:
                                    try:
                                        ...
                                        try:
                                            if don_in_lobby[game_id] in list_names and don_vote[don_in_lobby[game_id]]:
